...
VisionSpec v0.1.0 is the initial release providing multi-domain specification orchestration for humans and AI agents. This release establishes the foundation for bridging organizational intent (MRD, PRD, UXD) with executable specifications for AI coding agents.
...
- **Project Configuration**: `visionspec.yaml` for project-level settings and target configuration
...
```bash
go install github.com/ProductBuildersHQ/visionspec/cmd/visionspec@v0.1.0
```
