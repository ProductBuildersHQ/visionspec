...
cases. The default library of 25 workflows is embedded directly in this
repo (`pkg/workflows`) and loaded into the binary with no filesystem
access. The stage-based profiles:
